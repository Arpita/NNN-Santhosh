...
import com.example.kvsan.restapi.HomeScreen;
...
public class VideoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.videorecyclerviewid);
        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(this);
        recyclerView.setLayoutManager(layoutManager);

        final String categorySelected = getIntent().getStringExtra("categoryname");
        final String url = "https://api.vimeo.com/categories/" + categorySelected + "/videos";
        final GetVideoList getVideoList = new GetVideoList();
        getVideoList.execute(url);
    }
    ...
    public class GetVideoList extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                RecyclerView.Adapter categoryAdapter = new RecyclerViewAdapterVideos(VideoActivity.this, dataModelList);
